...
<%
    ...
    saveurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_SAVE_DISPUTE_MCSUPERVISOR;
    viewurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_VIEW_DISPUTE_MCSUPERVISOR;
    deleteurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_DELETE_DISPUTE_MCSUPERVISOR;
    editurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_EDIT_DISPUTE_MCSUPERVISOR;
    finishurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_FINISH_DISPUTE_MCSUPERVISOR;
    welcomeurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_WELCOME_PART;
    if (currentParcel.getHolding() == 1) {
        backurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_PERSONS_WITH_INTEREST_LIST_MCSUPERVISOR;
    } else {
