...
<%
    ...
    nexturl = request.getContextPath() + "/Index?action=" + Constants.ACTION_VIEW_HOLDER_MCSUPERVISOR;
    editurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_EDIT_PARCEL_MCSUPERVISOR;
    deleteurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_DELETE_PARCEL_MCSUPERVISOR;
