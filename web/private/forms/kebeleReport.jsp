    ...
    <div class="col-lg-12 col-lg-offset-0">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">Kebele Report</h3>
            </div>
                ...
                <table class="table table-striped table-bordered table-hover col-lg-12" id="reportTable">
                    ...
                    <tbody>
                        ...
                        for (String title : titles) {
                            if(title.equalsIgnoreCase("kebele") || title.equalsIgnoreCase("Woreda name") || title.equalsIgnoreCase("Woreda id") || title.equalsIgnoreCase("Report generated on")){
                                continue;
                            }
                            out.println("<tr>");
                            out.println("<td style='text-align: left'>" + title+ "</td>");
