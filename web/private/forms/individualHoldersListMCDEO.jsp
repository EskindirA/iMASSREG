...
<%
    ...
    if (CommonStorage.getCurrentUser(request).getRole() == Constants.ROLE.CORRECTION_FIRST_ENTRY_OPERATOR) {
        saveurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_SAVE_HOLDER_MCFEO;
        viewurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_VIEW_INDIVIDUAL_HOLDER_MCFEO;
        editurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_EDIT_INDIVIDUAL_HOLDER_MCFEO;
        deleteurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_DELETE_INDIVIDUAL_HOLDER_MCFEO;
        backurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_VIEW_PARCEL_MCFEO;
        if (currentParcel.hasOrphanHolder()) {
            nexturl = request.getContextPath() + "/Index?action=" + Constants.ACTION_GUARDIANS_LIST_MCFEO;
        } else {
            nexturl = request.getContextPath() + "/Index?action=" + Constants.ACTION_PERSONS_WITH_INTEREST_LIST_MCFEO;
        }
    } else {
        saveurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_SAVE_HOLDER_MCSEO;
        viewurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_VIEW_INDIVIDUAL_HOLDER_MCSEO;
        editurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_EDIT_INDIVIDUAL_HOLDER_MCSEO;
        deleteurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_DELETE_INDIVIDUAL_HOLDER_MCSEO;
        backurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_VIEW_PARCEL_MCSEO;
        if (currentParcel.hasOrphanHolder()) {
            nexturl = request.getContextPath() + "/Index?action=" + Constants.ACTION_GUARDIANS_LIST_MCSEO;
        } else {
...
<script type="text/javascript">
    ...
    function validate(formId) {
        ...
        $("#" + formId + " #deceased").toggleClass("error-field", false);
        ...
        if ($("#" + formId + " #deceased").val().trim() === "") {
            returnValue = false;
            $("#" + formId + " #deceased").toggleClass("error-field", true);
        }
