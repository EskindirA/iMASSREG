<%@page import="org.lift.massreg.dto.PublicDisplayCheckList"%>
<%@page import="org.lift.massreg.util.CommonStorage"%>
<%@page import="java.util.ArrayList"%>
<%@page import="org.lift.massreg.dto.HolderPublicDisplayDTO"%>
<%
    ArrayList<PublicDisplayCheckList> list = (ArrayList<PublicDisplayCheckList>) request.getAttribute("list");
%>
<style>
