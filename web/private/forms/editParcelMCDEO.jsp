...
<%
    ...
    if (CommonStorage.getCurrentUser(request).getRole() == Constants.ROLE.CORRECTION_FIRST_ENTRY_OPERATOR) {
        updateurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_UPDATE_PARCEL_MCFEO;
        cancelurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_VIEW_PARCEL_MCFEO;
        backurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_WELCOME_PART;
    } else {
        updateurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_UPDATE_PARCEL_MCSEO;
        cancelurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_VIEW_PARCEL_MCSEO;
        backurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_WELCOME_PART;
    }
%>
