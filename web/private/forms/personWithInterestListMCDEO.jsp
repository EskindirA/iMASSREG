...
<%
    ...
    if (CommonStorage.getCurrentUser(request).getRole() == Constants.ROLE.CORRECTION_FIRST_ENTRY_OPERATOR) {
        saveurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_SAVE_PERSON_WITH_INTEREST_MCFEO;
        viewurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_VIEW_PERSON_WITH_INTEREST_MCFEO;
        editurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_EDIT_PERSON_WITH_INTEREST_MCFEO;
        deleteurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_DELETE_PERSON_WITH_INTEREST_MCFEO;
        if (currentParcel.hasOrphanHolder()) {
            backurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_GUARDIANS_LIST_MCFEO;
        } else {
            backurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_VIEW_HOLDER_MCFEO;
        }
        nexturl = request.getContextPath() + "/Index?action=" + Constants.ACTION_DISPUTE_LIST_MCFEO;
        finshurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_FINISH_PERSON_WITH_INTEREST_MCFEO;
    } else {
        saveurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_SAVE_PERSON_WITH_INTEREST_MCSEO;
        viewurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_VIEW_PERSON_WITH_INTEREST_MCSEO;
        editurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_EDIT_PERSON_WITH_INTEREST_MCSEO;
        deleteurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_DELETE_PERSON_WITH_INTEREST_MCSEO;
        nexturl = request.getContextPath() + "/Index?action=" + Constants.ACTION_DISPUTE_LIST_MCSEO;
        if (currentParcel.hasOrphanHolder()) {
            backurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_GUARDIANS_LIST_MCSEO;
        } else {
            backurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_VIEW_HOLDER_MCSEO;
        }
        finshurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_FINISH_PERSON_WITH_INTEREST_MCSEO;
    }
%>
<div class="col-lg-12">
    <div class="row">
