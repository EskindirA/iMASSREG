...
<%
    ...
    saveurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_SAVE_PERSON_WITH_INTEREST_MCSUPERVISOR;
    viewurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_VIEW_PERSON_WITH_INTEREST_MCSUPERVISOR;
    editurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_EDIT_PERSON_WITH_INTEREST_MCSUPERVISOR;
    deleteurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_DELETE_PERSON_WITH_INTEREST_MCSUPERVISOR;
    backurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_VIEW_HOLDER_MCSUPERVISOR;
    nexturl = request.getContextPath() + "/Index?action=" + Constants.ACTION_DISPUTE_LIST_MCSUPERVISOR;
    finshurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_FINISH_PERSON_WITH_INTEREST_MCSUPERVISOR;
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading"> 
                    ...
                    %>
                                        <span style='float:right' class='<%= parcelDifference.isPersonsWithInterestCount()
