...
<%
    ...
    saveurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_SAVE_GUARDIAN_MCSUPERVISOR;
    viewurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_VIEW_GUARDIAN_MCSUPERVISOR;
    editurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_EDIT_GUARDIAN_MCSUPERVISOR;
    deleteurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_DELETE_GUARDIAN_MCSUPERVISOR;
    ...
    function save() {
        $.ajax({
            ...
            data: {
                ...
                "physicalImpairment": $("#addGuardianForm #physicalImpairment").val(),
