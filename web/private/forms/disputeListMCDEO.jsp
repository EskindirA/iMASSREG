...
<%
    ...
    if (CommonStorage.getCurrentUser(request).getRole() == Constants.ROLE.CORRECTION_FIRST_ENTRY_OPERATOR) {
        saveurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_SAVE_DISPUTE_MCFEO;
        viewurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_VIEW_DISPUTE_MCFEO;
        deleteurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_DELETE_DISPUTE_MCFEO;
        editurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_EDIT_DISPUTE_MCFEO;
        finishurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_FINISH_DISPUTE_MCFEO;
        if (currentParcel.getHolding() == 1) {
            backurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_PERSONS_WITH_INTEREST_LIST_MCFEO;
        } else {
            backurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_VIEW_HOLDER_MCFEO;
        }
    } else {
        saveurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_SAVE_DISPUTE_MCSEO;
        viewurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_VIEW_DISPUTE_MCSEO;
        deleteurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_DELETE_DISPUTE_MCSEO;
        editurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_EDIT_DISPUTE_MCSEO;
        finishurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_FINISH_DISPUTE_MCSEO;
        if (currentParcel.getHolding() == 1) {
            backurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_PERSONS_WITH_INTEREST_LIST_MCSEO;
        } else {
