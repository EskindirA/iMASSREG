...
<%
    ...
    if (CommonStorage.getCurrentUser(request).getRole() == Constants.ROLE.CORRECTION_FIRST_ENTRY_OPERATOR) {
        finishurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_FINISH_ORGANIZATION_HOLDER_MCFEO;
        editurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_EDIT_ORGANIZATION_HOLDER_MCFEO;
        ...
        finishurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_FINISH_ORGANIZATION_HOLDER_MCSEO;
        editurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_EDIT_ORGANIZATION_HOLDER_MCSEO;
                                ...
                                <div class="form-group">
                                    ...
                                    <option value=""><%=CommonStorage.getText("please_select_a_value")%></option>
                                        <%
                                            ...
                                            for (int i = 0; i < organizationTypes.length-1; i++) {
