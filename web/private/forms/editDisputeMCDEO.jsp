...
<%
    ...
    if (CommonStorage.getCurrentUser(request).getRole() == Constants.ROLE.CORRECTION_FIRST_ENTRY_OPERATOR) {
        updateurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_UPDATE_DISPUTE_MCFEO;
    } else {
        updateurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_UPDATE_DISPUTE_MCSEO;
    }
%>
