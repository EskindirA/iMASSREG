...
<%
    ...
    nexturl = request.getContextPath() + "/Index?action=" + Constants.ACTION_VIEW_HOLDER_PDC;
                    ...
                    <form role="form" action="#" id="addParcelForm">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="row">
                                    <input type="submit" id = "nextButton" name = "nextButton" class="btn btn-default col-lg-offset-8 col-lg-3" value="<%=CommonStorage.getText("next")%>" />
                                </div>
                            </div> <!-- /.col-lg-6 (nested) -->
                        </div> <!-- /.row (nested) -->
                    </form>
