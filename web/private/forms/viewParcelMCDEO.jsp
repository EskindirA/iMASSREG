...
<%
    ...
    if (CommonStorage.getCurrentUser(request).getRole() == Constants.ROLE.CORRECTION_FIRST_ENTRY_OPERATOR) {
        nexturl = request.getContextPath() + "/Index?action=" + Constants.ACTION_VIEW_HOLDER_MCFEO;
        editurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_EDIT_PARCEL_MCFEO;
        deleteurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_DELETE_PARCEL_MCFEO;
        backurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_WELCOME_PART;
    } else {
        nexturl = request.getContextPath() + "/Index?action=" + Constants.ACTION_VIEW_HOLDER_MCSEO;
        editurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_EDIT_PARCEL_MCSEO;
        deleteurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_DELETE_PARCEL_MCSEO;
        backurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_WELCOME_PART;
    }
%>
