...
<%
    ...
    nexturl = request.getContextPath() + "/Index?action=" + Constants.ACTION_VIEW_HOLDER_SUPERVISOR;
    editurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_EDIT_PARCEL_SUPERVISOR;
    deleteurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_DELETE_PARCEL_SUPERVISOR;
