...
<%
    ...
    if (CommonStorage.getCurrentUser(request).getRole() == Constants.ROLE.CORRECTION_FIRST_ENTRY_OPERATOR) {
        addurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_ADD_PARCEL_MCFEO;
        findurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_FIND_PARCEL_MCFEO;
    } else {
        addurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_ADD_PARCEL_MCSEO;
        findurl = request.getContextPath() + "/Index?action=" + Constants.ACTION_FIND_PARCEL_MCSEO;
    }
%>
