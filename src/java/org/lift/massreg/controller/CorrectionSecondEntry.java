 ...
 * @since 2.0
 */
public class CorrectionSecondEntry {
    ...
    protected static void addParcel(HttpServletRequest request, HttpServletResponse response)
        ...
        else if (!MasterRepository.getInstance().isParcelComplete(request.getAttribute("upi").toString(), CommonStorage.getMajorCorrectionFEStage())) {
            request.getSession().setAttribute("title", "Error");
        ...
        // already exists
        else if (MasterRepository.getInstance().parcelExists(request.getAttribute("upi").toString(), CommonStorage.getMajorCorrectionSEStage())) {
            request.getSession().setAttribute("title", "Error");
        ...
        else if (MasterRepository.getInstance().getParcel(request.getAttribute("upi").toString(), CommonStorage.getMajorCorrectionFEStage()).getRegisteredBy() == CommonStorage.getCurrentUser(request).getUserId()) {
            request.getSession().setAttribute("title", "Error");
    ...
    protected static void editParcel(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        Parcel currentParcel = MasterRepository.getInstance().getParcel(request.getSession().getAttribute("upi").toString(), CommonStorage.getMajorCorrectionSEStage());
    ...
    protected static void saveParcel(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            p.setStage(CommonStorage.getMajorCorrectionSEStage());
            ...
            if (p.validateForSave()) {
                ...
                request.getSession().setAttribute("returnAction", Constants.ACTION_ADD_PARCEL_MCSEO);
                RequestDispatcher rd = request.getServletContext().getRequestDispatcher(IOC.getPage(Constants.INDEX_MESSAGE));
                rd.forward(request, response);
            }
    ...
    protected static void updateParcel(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        Parcel oldParcel = MasterRepository.getInstance().getParcel(request.getSession().getAttribute("upi").toString(), CommonStorage.getMajorCorrectionSEStage());
        ...
        try {
            ...
            if (newParcel.validateForUpdate()) {
                ...
                request.getSession().setAttribute("returnAction", Constants.ACTION_VIEW_PARCEL_MCSEO);
                RequestDispatcher rd = request.getServletContext().getRequestDispatcher(IOC.getPage(Constants.INDEX_MESSAGE));
                rd.forward(request, response);
            }
        } catch (NumberFormatException | ServletException | IOException ex) {
    ...
    protected static void saveOrganizationHolder(HttpServletRequest request, HttpServletResponse response)
        ...
        if (parcel != null) {
            ...
            try {
                ...
                oh.setStage(CommonStorage.getMajorCorrectionSEStage());
    ...
    protected static void updateOrganizationHolder(HttpServletRequest request,
        ...
        Parcel currentParcel = MasterRepository.getInstance().getParcel(
                request.getSession().getAttribute("upi").toString(), CommonStorage.getMajorCorrectionSEStage());
        request.setAttribute("currentParcel", currentParcel);
        ...
        try {
            ...
            if (newOrganizationHolder.validateForUpdate()) {
                ...
                request.getSession().setAttribute("message", "Sorry, there was a validation error ");
                request.getSession().setAttribute("returnTitle", "Go back to holder list");
                request.getSession().setAttribute("returnAction", Constants.ACTION_VIEW_HOLDER_MCSEO);
                RequestDispatcher rd = request.getServletContext().getRequestDispatcher(IOC.getPage(Constants.INDEX_MESSAGE));
                rd.forward(request, response);
            }
    ...
    protected static void saveIndividualHolder(HttpServletRequest request, HttpServletResponse response)
        ...
        if (parcel != null) {
            ...
            try {
                ...
                ih.setStage(CommonStorage.getMajorCorrectionSEStage());
    ...
    protected static void deleteIndividualHolder(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        if (IndividualHolder.delete(request, request.getParameter("holderId"), Timestamp.valueOf(request.getParameter("registeredOn")), request.getSession().getAttribute("upi").toString(), CommonStorage.getMajorCorrectionSEStage())) {
            Parcel parcel = MasterRepository.getInstance().getParcel(request.getSession().getAttribute("upi").toString(), CommonStorage.getMajorCorrectionSEStage());
            request.setAttribute("currentParcel", parcel);
            individualHolderList(request, response);
        } else {
    ...
    protected static void editIndividualHolder(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("currentParcel", currentParcel);
        // if the parcel does not exit in the database 
        if (!MasterRepository.getInstance().parcelExists(request.getAttribute("upi").toString(), CommonStorage.getMajorCorrectionSEStage())) {
            request.getSession().setAttribute("title", "Error");
    ...
    protected static void savePersonWithInterest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (parcel != null) {
            ...
            try {
                ...
                pwi.setStage(CommonStorage.getMajorCorrectionSEStage());
                ...
                if (pwi.validateForSave()) {
                    ...
                    request.getSession().setAttribute("returnAction", Constants.ACTION_PERSONS_WITH_INTEREST_LIST_MCSEO);
                    RequestDispatcher rd = request.getServletContext().getRequestDispatcher(IOC.getPage(Constants.INDEX_MESSAGE));
                    rd.forward(request, response);
                }
    ...
    protected static void deletePersonWithInterest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        if (PersonWithInterest.delete(request, Timestamp.valueOf(request.getParameter("registeredOn")), request.getSession().getAttribute("upi").toString(), CommonStorage.getMajorCorrectionSEStage())) {
            personsWithInterestList(request, response);
        } else {
            // if the parcel fails to validate show error message
            request.getSession().setAttribute("title", "Delete Error");
    ...
    protected static void saveDispute(HttpServletRequest request, HttpServletResponse response)
        ...
        if (parcel != null) {
            ...
            try {
                ...
                dispute.setStage(CommonStorage.getMajorCorrectionSEStage());
                ...
                if (dispute.validateForSave()) {
                    ...
                    request.getSession().setAttribute("message", "Sorry, there was a validation error ");
                    request.getSession().setAttribute("returnTitle", "Go back to dispute list");
                    request.getSession().setAttribute("returnAction", Constants.ACTION_DISPUTE_LIST_MCSEO);
                    RequestDispatcher rd = request.getServletContext().getRequestDispatcher(IOC.getPage(Constants.INDEX_MESSAGE));
                    rd.forward(request, response);
                }
    ...
    protected static void editDispute(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!MasterRepository.getInstance().parcelExists(request.getAttribute("upi").toString(), CommonStorage.getMajorCorrectionSEStage())) {
            ...
            request.setAttribute("page", IOC.getPage(Constants.INDEX_EDIT_DISPUTE_MCDEO));
    ...
    protected static void updateDispute(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            newDispute.setStage(CommonStorage.getMajorCorrectionSEStage());
    ...
    protected static void deleteDispute(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        if (Dispute.delete(request, Timestamp.valueOf(request.getParameter("registeredOn")), request.getSession().getAttribute("upi").toString(), CommonStorage.getMajorCorrectionSEStage())) {
            Parcel parcel = MasterRepository.getInstance().getParcel(request.getSession().getAttribute("upi").toString(), CommonStorage.getMajorCorrectionSEStage());
            request.setAttribute("currentParcel", parcel);
            viewDisputeList(request, response);
        } else {
    ...
    protected static void updateGuardian(HttpServletRequest request,
        ...
        try {
            ...
            if (newGuardian.validateForUpdate()) {
                ...
                request.getSession().setAttribute("returnAction", Constants.ACTION_GUARDIANS_LIST_MCSEO);
                RequestDispatcher rd = request.getServletContext().getRequestDispatcher(IOC.getPage(Constants.INDEX_MESSAGE));
                rd.forward(request, response);
            }
    ...
    protected static void commit(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!seoParcel.canEdit(CommonStorage.getCurrentUser(request).getRole())) {
            ...
            RequestDispatcher rd = request.getServletContext().getRequestDispatcher(IOC.getPage(Constants.INDEX_DISCREPANCY_MCDEO));
            rd.forward(request, response);
        }
    }
    ...
    protected static void deleteGuardian(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        if (Guardian.delete(request, Timestamp.valueOf(request.getParameter("registeredOn")), request.getSession().getAttribute("upi").toString(), CommonStorage.getMajorCorrectionSEStage())) {
            guardiansList(request, response);
        } else {
            // if the parcel fails to validate show error message
            request.getSession().setAttribute("title", "Delete Error");
    ...
    protected static void saveGuardian(HttpServletRequest request, HttpServletResponse response)
        ...
        if (parcel != null) {
            ...
            try {
                ...
                guardian.setStage(CommonStorage.getMajorCorrectionSEStage());
