...
public class ReportUtil {
    ...
    public static Workbook generateCompletionReport(long kebele, String kebeleName, String fileName, long stage) {
        String stageExpression = "stage > 9";
        if(stage==10){
            stageExpression = "stage = 10";
        }else if(stage==12){
            stageExpression = "stage = 12";
        }
        MasterRepository.getInstance().updateParcelArea(kebele);
        refreshViews();
        Workbook wb = new XSSFWorkbook();
        try {
            ...
            try (FileOutputStream fileOut = new FileOutputStream(fileName)) {
                ...
                row10.createCell(3).setCellValue(createHelper.createRichTextString("All"));
                //Unique Records
                row2.createCell(4).setCellValue(MasterRepository.getInstance().getCountOfMarriedCoupleHolders(kebele, stageExpression));
                row3.createCell(4).setCellValue(MasterRepository.getInstance().getCountOfSingleFemaleHolders(kebele, stageExpression));
                row4.createCell(4).setCellValue(MasterRepository.getInstance().getCountOfSingleMaleHolders(kebele, stageExpression));
                row5.createCell(4).setCellValue(MasterRepository.getInstance().getCountOfOrphanHolders(kebele, stageExpression));
                row6.createCell(4).setCellValue(MasterRepository.getInstance().getCountOfNonNaturalHolders(kebele, stageExpression));
                row7.createCell(4).setCellValue(MasterRepository.getInstance().getCountOfHoldersOfOtherHoldingTypes(kebele, stageExpression));
                row8.createCell(4).setCellValue(MasterRepository.getInstance().getNumberOfPeopleAllDisputes(kebele, stageExpression));
                row9.createCell(4).setCellValue(createHelper.createRichTextString("--")/*Data Not available*/);
                row10.createCell(4).setCellValue(createHelper.createRichTextString("--")/*Data Not available*/);
                // Total Parcels Demarcated / NEWLY PREFERED TO BE REFERED AS DIGITIZED
//                row2.createCell(5).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
//                row3.createCell(5).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
//                row4.createCell(5).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
//                row5.createCell(5).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
...
//                row8.createCell(5).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
//                row9.createCell(5).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                ResultSet set = null;//  MasterRepository.getInstance().getSpatialKebeleParcelIds(kebele);
                row2.createCell(5).setCellValue(MasterRepository.getInstance().getCountOfLandholderTypeDemarcatedParcels(kebele,1,stageExpression,set));
                row3.createCell(5).setCellValue(MasterRepository.getInstance().getCountOfLandholderTypeDemarcatedParcels(kebele,2,stageExpression,set));
                row4.createCell(5).setCellValue(MasterRepository.getInstance().getCountOfLandholderTypeDemarcatedParcels(kebele,3,stageExpression,set));
                row5.createCell(5).setCellValue(MasterRepository.getInstance().getCountOfLandholderTypeDemarcatedParcels(kebele,4,stageExpression,set));
                row6.createCell(5).setCellValue(MasterRepository.getInstance().getCountOfLandholderTypeDemarcatedParcels(kebele,5,stageExpression,set));
                row7.createCell(5).setCellValue(MasterRepository.getInstance().getCountOfLandholderTypeDemarcatedParcels(kebele,6,stageExpression,set));
                row8.createCell(5).setCellValue(MasterRepository.getInstance().getCountOfLandholderTypeDemarcatedParcels(kebele,7,stageExpression,set));
                row9.createCell(5).setCellValue(createHelper.createRichTextString("---"));
                row10.createCell(5).setCellValue(MasterRepository.getInstance().getCountOfDemarcatedParcels(kebele));
                // Average Number of Parcels
                row2.createCell(6).setCellValue(MasterRepository.getInstance().getAverageNumberOfParcelsPerMarriedCoupleHolder(kebele, stageExpression));
                row3.createCell(6).setCellValue(MasterRepository.getInstance().getAverageNumberOfParcelsPerSingleFemaleHolder(kebele, stageExpression));
                row4.createCell(6).setCellValue(MasterRepository.getInstance().getAverageNumberOfParcelsPerSingleMaleHolder(kebele, stageExpression));
                row5.createCell(6).setCellValue(MasterRepository.getInstance().getAverageNumberOfParcelsPerOrphanHolder(kebele, stageExpression));
                row6.createCell(6).setCellValue(MasterRepository.getInstance().getAverageNumberOfParcelsPerNonNaturalHolder(kebele, stageExpression));
                row7.createCell(6).setCellValue(MasterRepository.getInstance().getAverageNumberOfParcelsPerOtherHoldingType(kebele, stageExpression));
                row8.createCell(6).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row9.createCell(6).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row10.createCell(6).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                //Total number of non committed parcels
                ...
                row10.createCell(7).setCellValue(MasterRepository.getInstance().getCountOfAllNonCommittedParcels(kebele));
                // Total number of committed parcels
                row2.createCell(8).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderMarriedCoupleHolders(kebele, stageExpression));
                row3.createCell(8).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleFemaleHolders(kebele, stageExpression));
                row4.createCell(8).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleMaleHolders(kebele, stageExpression));
                row5.createCell(8).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOrphanHolders(kebele, stageExpression));
                row6.createCell(8).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHolders(kebele, stageExpression));
                row7.createCell(8).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOtherHoldingTypes(kebele, stageExpression));
                row8.createCell(8).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDispute(kebele, stageExpression));
                row9.createCell(8).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row10.createCell(8).setCellValue(MasterRepository.getInstance().getCountOfAllCommittedParcels(kebele, stageExpression));
                //Total Area
                row2.createCell(9).setCellValue(MasterRepository.getInstance().getTotalAreaOfParcelsUnderMarriedCoupleHolders(kebele, stageExpression));
                row3.createCell(9).setCellValue(MasterRepository.getInstance().getTotalAreaOfParcelsUnderSingleFemaleHolders(kebele, stageExpression));
                row4.createCell(9).setCellValue(MasterRepository.getInstance().getTotalAreaOfParcelsUnderSingleMaleHolders(kebele, stageExpression));
                row5.createCell(9).setCellValue(MasterRepository.getInstance().getTotalAreaOfParcelsUnderOrphanHolders(kebele, stageExpression));
                row6.createCell(9).setCellValue(MasterRepository.getInstance().getTotalAreaOfParcelsUnderNonNaturalHolders(kebele, stageExpression));
                row7.createCell(9).setCellValue(MasterRepository.getInstance().getTotalAreaOfParcelsUnderOtherHoldingTypes(kebele, stageExpression));
                row8.createCell(9).setCellValue(MasterRepository.getInstance().getTotalAreaOfParcelsUnderDispute(kebele, stageExpression));
                row9.createCell(9).setCellValue(MasterRepository.getInstance().getTotalAreaOfParcelsWithNoData(kebele, stageExpression));
                row10.createCell(9).setCellValue(MasterRepository.getInstance().getTotalAreaOfAllParcels(kebele));
                // Average area
                row2.createCell(10).setCellValue(MasterRepository.getInstance().getAverageAreaOfParcelsUnderMarriedCoupleHolders(kebele, stageExpression));
                row3.createCell(10).setCellValue(MasterRepository.getInstance().getAverageAreaOfParcelsUnderSingleFemaleHolders(kebele, stageExpression));
                row4.createCell(10).setCellValue(MasterRepository.getInstance().getAverageAreaOfParcelsUnderSingleMaleHolders(kebele, stageExpression));
                row5.createCell(10).setCellValue(MasterRepository.getInstance().getAverageAreaOfParcelsUnderOrphanHolders(kebele, stageExpression));
                row6.createCell(10).setCellValue(MasterRepository.getInstance().getAverageAreaOfParcelsUnderNonNaturalHolders(kebele, stageExpression));
                row7.createCell(10).setCellValue(MasterRepository.getInstance().getAverageAreaOfParcelsUnderOtherHoldingTypes(kebele, stageExpression));
                row8.createCell(10).setCellValue(MasterRepository.getInstance().getAverageAreaOfParcelsUnderDispute(kebele, stageExpression));
                row9.createCell(10).setCellValue(MasterRepository.getInstance().getAverageAreaOfParcelsWithNoData(kebele, stageExpression));
                row10.createCell(10).setCellValue(MasterRepository.getInstance().getAverageAreaOfAllParcels(kebele));
                //......
                //Court Decision
                row2.createCell(11).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderMarriedCoupleHoldersByOwnershipEvidence(kebele, (byte) 1/*Court Decision*/, stageExpression));
                row3.createCell(11).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleFemaleHoldersByOwnershipEvidence(kebele, (byte) 1/*Court Decision*/, stageExpression));
                row4.createCell(11).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleMaleHoldersByOwnershipEvidence(kebele, (byte) 1/*Court Decision*/, stageExpression));
                row5.createCell(11).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOrphanHoldersByOwnershipEvidence(kebele, (byte) 1/*Court Decision*/, stageExpression));
                row6.createCell(11).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHoldersByOwnershipEvidence(kebele, (byte) 1/*Court Decision*/, stageExpression));
                row7.createCell(11).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOtherHoldingTypesByOwnershipEvidence(kebele, (byte) 1/*Court Decision*/, stageExpression));
                row8.createCell(11).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeByOwnershipEvidence(kebele, (byte) 1/*Court Decision*/, stageExpression));
                row9.createCell(11).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row10.createCell(11).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsByOwnershipEvidence(kebele, (byte) 1/*Court Decision*/, stageExpression));
                //Tax Receipt
                row2.createCell(12).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderMarriedCoupleHoldersByOwnershipEvidence(kebele, (byte) 2/*Tax Receipt*/, stageExpression));
                row3.createCell(12).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleFemaleHoldersByOwnershipEvidence(kebele, (byte) 2/*Tax Receipt*/, stageExpression));
                row4.createCell(12).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleMaleHoldersByOwnershipEvidence(kebele, (byte) 2/*Tax Receipt*/, stageExpression));
                row5.createCell(12).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOrphanHoldersByOwnershipEvidence(kebele, (byte) 2/*Tax Receipt*/, stageExpression));
                row6.createCell(12).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHoldersByOwnershipEvidence(kebele, (byte) 2/*Tax Receipt*/, stageExpression));
                row7.createCell(12).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOtherHoldingTypesByOwnershipEvidence(kebele, (byte) 2/*Tax Receipt*/, stageExpression));
                row8.createCell(12).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeByOwnershipEvidence(kebele, (byte) 2/*Tax Receipt*/, stageExpression));
                row9.createCell(12).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row10.createCell(12).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsByOwnershipEvidence(kebele, (byte) 2/*Tax Receipt*/, stageExpression));
                //Rain fed annual crops
                row2.createCell(13).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderMarriedCoupleHoldersByLandUseType(kebele, (byte) 1 /*Rain fed annual crops*/, stageExpression));
                row3.createCell(13).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleFemaleHoldersByLandUseType(kebele, (byte) 1 /*Rain fed annual crops*/, stageExpression));
                row4.createCell(13).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleMaleHoldersByLandUseType(kebele, (byte) 1 /*Rain fed annual crops*/, stageExpression));
                row5.createCell(13).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOrphanHoldersByLandUseType(kebele, (byte) 1 /*Rain fed annual crops*/, stageExpression));
                row6.createCell(13).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHoldersByLandUseType(kebele, (byte) 1 /*Rain fed annual crops*/, stageExpression));
                row7.createCell(13).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOtherHoldingTypesByLandUseType(kebele, (byte) 1 /*Rain fed annual crops*/, stageExpression));
                row8.createCell(13).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeByLandUseType(kebele, (byte) 1 /*Rain fed annual crops*/, stageExpression));
                row9.createCell(13).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row10.createCell(13).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsByLandUseType(kebele, (byte) 1 /*Rain fed annual crops*/, stageExpression));
                row2.createCell(14).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderMarriedCoupleHoldersByLandUseType(kebele, (byte) 2 /*Rain fed Perennial crops*/, stageExpression));
                row3.createCell(14).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleFemaleHoldersByLandUseType(kebele, (byte) 2 /*Rain fed Perennial crops*/, stageExpression));
                row4.createCell(14).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleMaleHoldersByLandUseType(kebele, (byte) 2 /*Rain fed Perennial crops*/, stageExpression));
                row5.createCell(14).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOrphanHoldersByLandUseType(kebele, (byte) 2 /*Rain fed Perennial crops*/, stageExpression));
                row6.createCell(14).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHoldersByLandUseType(kebele, (byte) 2 /*Rain fed Perennial crops*/, stageExpression));
                row7.createCell(14).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOtherHoldingTypesByLandUseType(kebele, (byte) 2 /*Rain fed Perennial crops*/, stageExpression));
                row8.createCell(14).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeByLandUseType(kebele, (byte) 2 /*Rain fed Perennial crops*/, stageExpression));
                row9.createCell(14).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row10.createCell(14).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsByLandUseType(kebele, (byte) 2 /*Rain fed Perennial crops*/, stageExpression));
                row2.createCell(15).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderMarriedCoupleHoldersByLandUseType(kebele, (byte) 3 /*Irrigated annual crops*/, stageExpression));
                row3.createCell(15).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleFemaleHoldersByLandUseType(kebele, (byte) 3 /*Irrigated annual crops*/, stageExpression));
                row4.createCell(15).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleMaleHoldersByLandUseType(kebele, (byte) 3 /*Irrigated annual crops*/, stageExpression));
                row5.createCell(15).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOrphanHoldersByLandUseType(kebele, (byte) 3 /*Irrigated annual crops*/, stageExpression));
                row6.createCell(15).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHoldersByLandUseType(kebele, (byte) 3 /*Irrigated annual crops*/, stageExpression));
                row7.createCell(15).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOtherHoldingTypesByLandUseType(kebele, (byte) 3 /*Irrigated annual crops*/, stageExpression));
                row8.createCell(15).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeByLandUseType(kebele, (byte) 3 /*Irrigated annual crops*/, stageExpression));
                row9.createCell(15).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row10.createCell(15).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsByLandUseType(kebele, (byte) 3 /*Irrigated annual crops*/, stageExpression));
                row2.createCell(16).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderMarriedCoupleHoldersByLandUseType(kebele, (byte) 4 /*Irrigated perennial crops*/, stageExpression));
                row3.createCell(16).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleFemaleHoldersByLandUseType(kebele, (byte) 4 /*Irrigated perennial crops*/, stageExpression));
                row4.createCell(16).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleMaleHoldersByLandUseType(kebele, (byte) 4 /*Irrigated perennial crops*/, stageExpression));
                row5.createCell(16).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOrphanHoldersByLandUseType(kebele, (byte) 4 /*Irrigated perennial crops*/, stageExpression));
                row6.createCell(16).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHoldersByLandUseType(kebele, (byte) 4 /*Irrigated perennial crops*/, stageExpression));
                row7.createCell(16).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOtherHoldingTypesByLandUseType(kebele, (byte) 4 /*Irrigated perennial crops*/, stageExpression));
                row8.createCell(16).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeByLandUseType(kebele, (byte) 4 /*Irrigated perennial crops*/, stageExpression));
                row9.createCell(16).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row10.createCell(16).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsByLandUseType(kebele, (byte) 4 /*Irrigated perennial crops*/, stageExpression));

                row2.createCell(17).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderMarriedCoupleHoldersByLandUseType(kebele, (byte) 5 /*Grazing Land*/, stageExpression));
                row3.createCell(17).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleFemaleHoldersByLandUseType(kebele, (byte) 5 /*Grazing Land*/, stageExpression));
                row4.createCell(17).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleMaleHoldersByLandUseType(kebele, (byte) 5 /*Grazing Land*/, stageExpression));
                row5.createCell(17).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOrphanHoldersByLandUseType(kebele, (byte) 5 /*Grazing Land*/, stageExpression));
                row6.createCell(17).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHoldersByLandUseType(kebele, (byte) 5 /*Grazing Land*/, stageExpression));
                row7.createCell(17).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOtherHoldingTypesByLandUseType(kebele, (byte) 5 /*Grazing Land*/, stageExpression));
                row8.createCell(17).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeByLandUseType(kebele, (byte) 5 /*Grazing Land*/, stageExpression));
                row9.createCell(17).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row10.createCell(17).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsByLandUseType(kebele, (byte) 5 /*Grazing Land*/, stageExpression));

                row2.createCell(18).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderMarriedCoupleHoldersByLandUseType(kebele, (byte) 7 /*Shrubland/Woodland*/, stageExpression));
                row3.createCell(18).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleFemaleHoldersByLandUseType(kebele, (byte) 7 /*Shrubland/Woodland*/, stageExpression));
                row4.createCell(18).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleMaleHoldersByLandUseType(kebele, (byte) 7 /*Shrubland/Woodland*/, stageExpression));
                row5.createCell(18).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOrphanHoldersByLandUseType(kebele, (byte) 7 /*Shrubland/Woodland*/, stageExpression));
                row6.createCell(18).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHoldersByLandUseType(kebele, (byte) 7 /*Shrubland/Woodland*/, stageExpression));
                row7.createCell(18).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOtherHoldingTypesByLandUseType(kebele, (byte) 7 /*Shrubland/Woodland*/, stageExpression));
                row8.createCell(18).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeByLandUseType(kebele, (byte) 7 /*Shrubland/Woodland*/, stageExpression));
                row9.createCell(18).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row10.createCell(18).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsByLandUseType(kebele, (byte) 7 /*Shrubland/Woodland*/, stageExpression));

                row2.createCell(19).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderMarriedCoupleHoldersByLandUseType(kebele, (byte) 8 /*Natural Forest*/, stageExpression));
                row3.createCell(19).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleFemaleHoldersByLandUseType(kebele, (byte) 8 /*Natural Forest*/, stageExpression));
                row4.createCell(19).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleMaleHoldersByLandUseType(kebele, (byte) 8 /*Natural Forest*/, stageExpression));
                row5.createCell(19).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOrphanHoldersByLandUseType(kebele, (byte) 8 /*Natural Forest*/, stageExpression));
                row6.createCell(19).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHoldersByLandUseType(kebele, (byte) 8 /*Natural Forest*/, stageExpression));
                row7.createCell(19).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOtherHoldingTypesByLandUseType(kebele, (byte) 8 /*Natural Forest*/, stageExpression));
                row8.createCell(19).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeByLandUseType(kebele, (byte) 8 /*Natural Forest*/, stageExpression));
                row9.createCell(19).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row10.createCell(19).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsByLandUseType(kebele, (byte) 8 /*Natural Forest*/, stageExpression));

                row2.createCell(20).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderMarriedCoupleHoldersByLandUseType(kebele, (byte) 9 /*Artificial Forest*/, stageExpression));
                row3.createCell(20).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleFemaleHoldersByLandUseType(kebele, (byte) 9 /*Artificial Forest*/, stageExpression));
                row4.createCell(20).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleMaleHoldersByLandUseType(kebele, (byte) 9 /*Artificial Forest*/, stageExpression));
                row5.createCell(20).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOrphanHoldersByLandUseType(kebele, (byte) 9 /*Artificial Forest*/, stageExpression));
                row6.createCell(20).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHoldersByLandUseType(kebele, (byte) 9 /*Artificial Forest*/, stageExpression));
                row7.createCell(20).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOtherHoldingTypesByLandUseType(kebele, (byte) 9 /*Artificial Forest*/, stageExpression));
                row8.createCell(20).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeByLandUseType(kebele, (byte) 9 /*Artificial Forest*/, stageExpression));
                row9.createCell(20).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row10.createCell(20).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsByLandUseType(kebele, (byte) 9 /*Artificial Forest*/, stageExpression));

                row2.createCell(21).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderMarriedCoupleHoldersByLandUseType(kebele, (byte) 10 /*Wetland*/, stageExpression));
                row3.createCell(21).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleFemaleHoldersByLandUseType(kebele, (byte) 10 /*Wetland*/, stageExpression));
                row4.createCell(21).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleMaleHoldersByLandUseType(kebele, (byte) 10 /*Wetland*/, stageExpression));
                row5.createCell(21).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOrphanHoldersByLandUseType(kebele, (byte) 10 /*Wetland*/, stageExpression));
                row6.createCell(21).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHoldersByLandUseType(kebele, (byte) 10 /*Wetland*/, stageExpression));
                row7.createCell(21).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOtherHoldingTypesByLandUseType(kebele, (byte) 10 /*Wetland*/, stageExpression));
                row8.createCell(21).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeByLandUseType(kebele, (byte) 10 /*Wetland*/, stageExpression));
                row9.createCell(21).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row10.createCell(21).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsByLandUseType(kebele, (byte) 10 /*Wetland*/, stageExpression));

                row2.createCell(22).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderMarriedCoupleHoldersByLandUseType(kebele, (byte) 11 /*Built-Up Areas*/, stageExpression));
                row3.createCell(22).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleFemaleHoldersByLandUseType(kebele, (byte) 11 /*Built-Up Areas*/, stageExpression));
                row4.createCell(22).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleMaleHoldersByLandUseType(kebele, (byte) 11 /*Built-Up Areas*/, stageExpression));
                row5.createCell(22).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOrphanHoldersByLandUseType(kebele, (byte) 11 /*Built-Up Areas*/, stageExpression));
                row6.createCell(22).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHoldersByLandUseType(kebele, (byte) 11 /*Built-Up Areas*/, stageExpression));
                row7.createCell(22).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOtherHoldingTypesByLandUseType(kebele, (byte) 11 /*Built-Up Areas*/, stageExpression));
                row8.createCell(22).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeByLandUseType(kebele, (byte) 11 /*Built-Up Areas*/, stageExpression));
                row9.createCell(22).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row10.createCell(22).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsByLandUseType(kebele, (byte) 11 /*Built-Up Areas*/, stageExpression));

                row2.createCell(23).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderMarriedCoupleHoldersByLandUseType(kebele, (byte) 12 /*Bareland*/, stageExpression));
                row3.createCell(23).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleFemaleHoldersByLandUseType(kebele, (byte) 12 /*Bareland*/, stageExpression));
                row4.createCell(23).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleMaleHoldersByLandUseType(kebele, (byte) 12 /*Bareland*/, stageExpression));
                row5.createCell(23).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOrphanHoldersByLandUseType(kebele, (byte) 12 /*Bareland*/, stageExpression));
                row6.createCell(23).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHoldersByLandUseType(kebele, (byte) 12 /*Bareland*/, stageExpression));
                row7.createCell(23).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOtherHoldingTypesByLandUseType(kebele, (byte) 12 /*Bareland*/, stageExpression));
                row8.createCell(23).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeByLandUseType(kebele, (byte) 12 /*Bareland*/, stageExpression));
                row9.createCell(23).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row10.createCell(23).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsByLandUseType(kebele, (byte) 12 /*Bareland*/, stageExpression));

                row2.createCell(24).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderMarriedCoupleHoldersBySoilFertility(kebele, (byte) 1 /*High/Good*/, stageExpression));
                row3.createCell(24).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleFemaleHoldersBySoilFertility(kebele, (byte) 1 /*High/Good*/, stageExpression));
                row4.createCell(24).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleMaleHoldersBySoilFertility(kebele, (byte) 1 /*High/Good*/, stageExpression));
                row5.createCell(24).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOrphanHoldersBySoilFertility(kebele, (byte) 1 /*High/Good*/, stageExpression));
                row6.createCell(24).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHoldersBySoilFertility(kebele, (byte) 1 /*High/Good*/, stageExpression));
                row7.createCell(24).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOtherHoldingTypesBySoilFertility(kebele, (byte) 1 /*High/Good*/, stageExpression));
                row8.createCell(24).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeBySoilFertility(kebele, (byte) 1 /*High/Good*/, stageExpression));
                row9.createCell(24).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row10.createCell(24).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsBySoilFertility(kebele, (byte) 1 /*High/Good*/, stageExpression));

                row2.createCell(25).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderMarriedCoupleHoldersBySoilFertility(kebele, (byte) 2 /*Medium/Fair*/, stageExpression));
                row3.createCell(25).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleFemaleHoldersBySoilFertility(kebele, (byte) 2 /*Medium/Fair*/, stageExpression));
                row4.createCell(25).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleMaleHoldersBySoilFertility(kebele, (byte) 2 /*Medium/Fair*/, stageExpression));
                row5.createCell(25).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOrphanHoldersBySoilFertility(kebele, (byte) 2 /*Medium/Fair*/, stageExpression));
                row6.createCell(25).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHoldersBySoilFertility(kebele, (byte) 2 /*Medium/Fair*/, stageExpression));
                row7.createCell(25).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOtherHoldingTypesBySoilFertility(kebele, (byte) 2 /*Medium/Fair*/, stageExpression));
                row8.createCell(25).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeBySoilFertility(kebele, (byte) 2 /*Medium/Fair*/, stageExpression));
                row9.createCell(25).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row10.createCell(25).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsBySoilFertility(kebele, (byte) 2 /*Medium/Fair*/, stageExpression));

                row2.createCell(26).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderMarriedCoupleHoldersBySoilFertility(kebele, (byte) 3 /*Low/Poor*/, stageExpression));
                row3.createCell(26).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleFemaleHoldersBySoilFertility(kebele, (byte) 3 /*Low/Poor*/, stageExpression));
                row4.createCell(26).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleMaleHoldersBySoilFertility(kebele, (byte) 3 /*Low/Poor*/, stageExpression));
                row5.createCell(26).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOrphanHoldersBySoilFertility(kebele, (byte) 3 /*Low/Poor*/, stageExpression));
                row6.createCell(26).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHoldersBySoilFertility(kebele, (byte) 3 /*Low/Poor*/, stageExpression));
                row7.createCell(26).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOtherHoldingTypesBySoilFertility(kebele, (byte) 3 /*Low/Poor*/, stageExpression));
                row8.createCell(26).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeBySoilFertility(kebele, (byte) 3 /*Low/Poor*/, stageExpression));
                row9.createCell(26).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row10.createCell(26).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsBySoilFertility(kebele, (byte) 3 /*Low/Poor*/, stageExpression));
                ...
                row2.createCell(34).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row2.createCell(35).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row2.createCell(36).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderMarriedCoupleHoldersByMeansOfAcquisition(kebele, (byte) 1 /*Redistribution*/, stageExpression));
                row2.createCell(37).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderMarriedCoupleHoldersByMeansOfAcquisition(kebele, (byte) 2 /*Inheritance*/, stageExpression));
                row2.createCell(38).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderMarriedCoupleHoldersByMeansOfAcquisition(kebele, (byte) 3 /*Gift*/, stageExpression));
                row2.createCell(39).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderMarriedCoupleHoldersByMeansOfAcquisition(kebele, (byte) 5 /*Divorce*/, stageExpression));
                row2.createCell(40).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderMarriedCoupleHoldersByMeansOfAcquisition(kebele, (byte) 4 /*Reallocation*/, stageExpression));
                row2.createCell(41).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderMarriedCoupleHoldersByMeansOfAcquisition(kebele, (byte) 7 /*OTHERS*/, stageExpression));
                row2.createCell(42).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderMarriedCoupleHoldersByEncumbrances(kebele, (byte) 1 /*Right of Way*/, stageExpression));
                row2.createCell(43).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderMarriedCoupleHoldersByEncumbrances(kebele, (byte) 2 /*Rental arrangement/ leases*/, stageExpression));
                row2.createCell(44).setCellValue(MasterRepository.getInstance().getCountOfMarriedCoupleHoldersWithPhysicalImpairment(kebele, stageExpression));
                row2.createCell(45).setCellValue(MasterRepository.getInstance().getCountOfMarriedCoupleHoldersWithoutPhysicalImpairment(kebele, stageExpression));

                row2.createCell(46).setCellValue(MasterRepository.getInstance().getCountOfParcelsWithPersonsOfInterestUnderMarriedCoupleHolders(kebele, stageExpression));
                row2.createCell(47).setCellValue(MasterRepository.getInstance().getCountOfPersonsWithInterestUnderMarriedCoupleHolders(kebele, stageExpression));
                row2.createCell(48).setCellValue(MasterRepository.getInstance().getAverageNumberOfPIPerParcelsUnderMarriedCoupleHolders(kebele, stageExpression));
                row2.createCell(49).setCellValue(MasterRepository.getInstance().getCountOfMalePersonsWithInterestUnderMarriedCoupleHolders(kebele, stageExpression));
                row2.createCell(50).setCellValue(MasterRepository.getInstance().getCountOfFemalePersonsWithInterestUnderMarriedCoupleHolders(kebele, stageExpression));
                row2.createCell(51).setCellValue(MasterRepository.getInstance().getCountOfParcelsWithGuardianUnderMarriedCoupleHolders(kebele, stageExpression));
                row2.createCell(52).setCellValue(MasterRepository.getInstance().getCountOfGuardiansForParcelsUnderMarriedCoupleHolders(kebele, stageExpression));
                row2.createCell(53).setCellValue(MasterRepository.getInstance().getAverageNumberOfGuardiansPerParcelsUnderMarriedCoupleHolders(kebele, stageExpression));
                row2.createCell(54).setCellValue(MasterRepository.getInstance().getCountOfMaleGuardiansForParcelsUnderMarriedCoupleHolders(kebele, stageExpression));
                row2.createCell(55).setCellValue(MasterRepository.getInstance().getCountOfFemaleGuardiansForParcelsUnderMarriedCoupleHolders(kebele, stageExpression));
                row2.createCell(56).setCellValue(MasterRepository.getInstance().getFirstDataEntryDateInKebeleForMarriedHolders(kebele, stageExpression));
                row2.createCell(57).setCellValue(MasterRepository.getInstance().getLastDataEntryDateInKebeleForMarriedHolders(kebele, stageExpression));
                ...
                row3.createCell(34).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row3.createCell(35).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row3.createCell(36).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleFemaleHoldersByMeansOfAcquisition(kebele, (byte) 1 /*Redistribution*/, stageExpression));
                row3.createCell(37).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleFemaleHoldersByMeansOfAcquisition(kebele, (byte) 2 /*Inheritance*/, stageExpression));
                row3.createCell(38).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleFemaleHoldersByMeansOfAcquisition(kebele, (byte) 3 /*Gift*/, stageExpression));
                row3.createCell(39).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleFemaleHoldersByMeansOfAcquisition(kebele, (byte) 5 /*Divorce*/, stageExpression));
                row3.createCell(40).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleFemaleHoldersByMeansOfAcquisition(kebele, (byte) 4 /*Reallocation*/, stageExpression));
                row3.createCell(41).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleFemaleHoldersByMeansOfAcquisition(kebele, (byte) 7 /*OTHERS*/, stageExpression));
                row3.createCell(42).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleFemaleHoldersByEncumbrances(kebele, (byte) 1 /*Right of Way*/, stageExpression));
                row3.createCell(43).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleFemaleHoldersByEncumbrances(kebele, (byte) 2 /*Rental arrangement/ leases*/, stageExpression));
                row3.createCell(44).setCellValue(MasterRepository.getInstance().getCountOfSingleFemaleHoldersWithPhysicalImpairment(kebele, stageExpression));
                row3.createCell(45).setCellValue(MasterRepository.getInstance().getCountOfSingleFemaleHoldersWithoutPhysicalImpairment(kebele, stageExpression));
                row3.createCell(46).setCellValue(MasterRepository.getInstance().getCountOfParcelsWithPersonsOfInterestUnderSingleFemaleHolders(kebele, stageExpression));
                row3.createCell(47).setCellValue(MasterRepository.getInstance().getCountOfPersonsWithInterestUnderSingleFemaleHolders(kebele, stageExpression));
                row3.createCell(48).setCellValue(MasterRepository.getInstance().getAverageNumberOfPIPerParcelsUnderSingleFemaleHolders(kebele, stageExpression));
                row3.createCell(49).setCellValue(MasterRepository.getInstance().getCountOfMalePersonsWithInterestUnderSingleFemaleHolders(kebele, stageExpression));
                row3.createCell(50).setCellValue(MasterRepository.getInstance().getCountOfFemalePersonsWithInterestUnderSingleFemaleHolders(kebele, stageExpression));
                row3.createCell(51).setCellValue(MasterRepository.getInstance().getCountOfParcelsWithGuardiansUnderSingleFemaleHolders(kebele, stageExpression));
                row3.createCell(52).setCellValue(MasterRepository.getInstance().getCountOfGuardiansForParcelsUnderSingleFemaleHolders(kebele, stageExpression));
                row3.createCell(53).setCellValue(MasterRepository.getInstance().getAverageNumberOfGuardiansPerParcelsUnderSingleFemaleHolders(kebele, stageExpression));
                row3.createCell(54).setCellValue(MasterRepository.getInstance().getCountOfMaleGuardiansForParcelsUnderSingleFemaleHolders(kebele, stageExpression));
                row3.createCell(55).setCellValue(MasterRepository.getInstance().getCountOfFemaleGuardiansForParcelsUnderSingleFemaleHolders(kebele, stageExpression));
                row3.createCell(56).setCellValue(MasterRepository.getInstance().getFirstDataEntryDateInKebeleForSingleFemaleHolders(kebele, stageExpression));
                row3.createCell(57).setCellValue(MasterRepository.getInstance().getLastDataEntryDateInKebeleForSingleFemaleHolders(kebele, stageExpression));
                ...
                row4.createCell(34).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row4.createCell(35).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row4.createCell(36).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleMaleHoldersByMeansOfAcquisition(kebele, (byte) 1 /*Redistribution*/, stageExpression));
                row4.createCell(37).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleMaleHoldersByMeansOfAcquisition(kebele, (byte) 2 /*Inheritance*/, stageExpression));
                row4.createCell(38).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleMaleHoldersByMeansOfAcquisition(kebele, (byte) 3 /*Gift*/, stageExpression));
                row4.createCell(39).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleMaleHoldersByMeansOfAcquisition(kebele, (byte) 5 /*Divorce*/, stageExpression));
                row4.createCell(40).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleMaleHoldersByMeansOfAcquisition(kebele, (byte) 4 /*Reallocation*/, stageExpression));
                row4.createCell(41).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleMaleHoldersByMeansOfAcquisition(kebele, (byte) 7 /*OTHERS*/, stageExpression));
                row4.createCell(42).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleMaleHoldersByEncumbrances(kebele, (byte) 1 /*Right of Way*/, stageExpression));
                row4.createCell(43).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderSingleMaleHoldersByEncumbrances(kebele, (byte) 2 /*Rental arrangement/ leases*/, stageExpression));
                row4.createCell(44).setCellValue(MasterRepository.getInstance().getCountOfSingleMaleHoldersWithPhysicalImpairment(kebele, stageExpression));
                row4.createCell(45).setCellValue(MasterRepository.getInstance().getCountOfSingleMaleHoldersWithoutPhysicalImpairment(kebele, stageExpression));
                row4.createCell(46).setCellValue(MasterRepository.getInstance().getCountOfParcelsWithPersonsOfInterestUnderSingleMaleHolders(kebele, stageExpression));
                row4.createCell(47).setCellValue(MasterRepository.getInstance().getCountOfPersonsWithInterestUnderSingleMaleHolders(kebele, stageExpression));
                row4.createCell(48).setCellValue(MasterRepository.getInstance().getAverageNumberOfPIPerParcelsUnderSingleMaleHolders(kebele, stageExpression));
                row4.createCell(49).setCellValue(MasterRepository.getInstance().getCountOfMalePersonsWithInterestUnderSingleMaleHolders(kebele, stageExpression));
                row4.createCell(50).setCellValue(MasterRepository.getInstance().getCountOfFemalePersonsWithInterestUnderSingleMaleHolders(kebele, stageExpression));

                row4.createCell(51).setCellValue(MasterRepository.getInstance().getCountOfParcelsWithGuardiansUnderSingleMaleHolders(kebele, stageExpression));
                row4.createCell(52).setCellValue(MasterRepository.getInstance().getCountOfGuardiansForParcelsUnderSingleMaleHolders(kebele, stageExpression));
                row4.createCell(53).setCellValue(MasterRepository.getInstance().getAverageNumberOfGuardiansPerParcelsUnderSingleMaleHolders(kebele, stageExpression));
                row4.createCell(54).setCellValue(MasterRepository.getInstance().getCountOfMaleGuardiansForParcelsUnderSingleMaleHolders(kebele, stageExpression));
                row4.createCell(55).setCellValue(MasterRepository.getInstance().getCountOfFemaleGuardiansForParcelsUnderSingleMaleHolders(kebele, stageExpression));
                row4.createCell(56).setCellValue(MasterRepository.getInstance().getFirstDataEntryDateInKebeleForSingleMaleHolders(kebele, stageExpression));
                row4.createCell(57).setCellValue(MasterRepository.getInstance().getLastDataEntryDateInKebeleForSingleMaleHolders(kebele, stageExpression));
                ...
                row5.createCell(34).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row5.createCell(35).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row5.createCell(36).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOrphanHoldersByMeansOfAcquisition(kebele, (byte) 1 /*Redistribution*/, stageExpression));
                row5.createCell(37).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOrphanHoldersByMeansOfAcquisition(kebele, (byte) 2 /*Inheritance*/, stageExpression));
                row5.createCell(38).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOrphanHoldersByMeansOfAcquisition(kebele, (byte) 3 /*Gift*/, stageExpression));
                row5.createCell(39).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOrphanHoldersByMeansOfAcquisition(kebele, (byte) 5 /*Divorce*/, stageExpression));
                row5.createCell(40).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOrphanHoldersByMeansOfAcquisition(kebele, (byte) 4 /*Reallocation*/, stageExpression));
                row5.createCell(41).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOrphanHoldersByMeansOfAcquisition(kebele, (byte) 7 /*OTHERS*/, stageExpression));
                row5.createCell(42).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOrphanHoldersByEncumbrances(kebele, (byte) 1 /*Right of Way*/, stageExpression));
                row5.createCell(43).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOrphanHoldersByEncumbrances(kebele, (byte) 2 /*Rental arrangement/ leases*/, stageExpression));
                row5.createCell(44).setCellValue(MasterRepository.getInstance().getCountOfOrphanHoldersWithPhysicalImpairment(kebele, stageExpression));
                row5.createCell(45).setCellValue(MasterRepository.getInstance().getCountOfOrphanHoldersWithoutPhysicalImpairment(kebele, stageExpression));
                row5.createCell(46).setCellValue(MasterRepository.getInstance().getCountOfParcelsWithPersonsOfInterestUnderOrphanHolders(kebele, stageExpression));
                row5.createCell(47).setCellValue(MasterRepository.getInstance().getCountOfPersonsWithInterestUnderOrphanHolders(kebele, stageExpression));
                row5.createCell(48).setCellValue(MasterRepository.getInstance().getAverageNumberOfPIPerParcelsUnderOrphanHolders(kebele, stageExpression));
                row5.createCell(49).setCellValue(MasterRepository.getInstance().getCountOfMalePersonsWithInterestUnderOrphanHolders(kebele, stageExpression));
                row5.createCell(50).setCellValue(MasterRepository.getInstance().getCountOfFemalePersonsWithInterestUnderOrphanHolders(kebele, stageExpression));

                row5.createCell(51).setCellValue(MasterRepository.getInstance().getCountOfParcelsWithGuardiansUnderOrphanHolders(kebele, stageExpression));
                row5.createCell(52).setCellValue(MasterRepository.getInstance().getCountOfGuardiansForParcelsUnderOrphanHolders(kebele, stageExpression));
                row5.createCell(53).setCellValue(MasterRepository.getInstance().getAverageNumberOfGuardiansPerParcelsUnderSingleMaleHolders(kebele, stageExpression));
                row5.createCell(54).setCellValue(MasterRepository.getInstance().getCountOfMaleGuardiansForParcelsUnderOrphanHolders(kebele, stageExpression));
                row5.createCell(55).setCellValue(MasterRepository.getInstance().getCountOfFemaleGuardiansForParcelsUnderOrphanHolders(kebele, stageExpression));
                row5.createCell(56).setCellValue(MasterRepository.getInstance().getFirstDataEntryDateInKebeleForOrphanHolders(kebele, stageExpression));
                row5.createCell(57).setCellValue(MasterRepository.getInstance().getLastDataEntryDateInKebeleForOrphanHolders(kebele, stageExpression));

                row6.createCell(27).setCellValue(createHelper.createRichTextString("---")/*Does not make sense*/);
                row6.createCell(28).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHoldersByHoldingType(kebele, (byte) 2 /*Communal*/, stageExpression));
                row6.createCell(29).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHoldersByHoldingType(kebele, (byte) 3 /*Public/Instituional*/, stageExpression));
                row6.createCell(30).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHoldersByHoldingType(kebele, (byte) 4 /*State*/, stageExpression));
                row6.createCell(31).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHoldersByOrganisationType(kebele, (byte) 2 /*Church*/, stageExpression));
                row6.createCell(32).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHoldersByOrganisationType(kebele, (byte) 3 /*Mosque*/, stageExpression));
                row6.createCell(33).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHoldersByOrganisationType(kebele, (byte) 1 /*School*/, stageExpression));
                row6.createCell(34).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHoldersByOrganisationType(kebele, (byte) 4 /*Health Center*/, stageExpression));
                row6.createCell(35).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHoldersByOrganisationType(kebele, (byte) 5 /*Other*/, stageExpression));
                row6.createCell(36).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHoldersByMeansOfAcquisition(kebele, (byte) 1 /*Redistribution*/, stageExpression));
                row6.createCell(37).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHoldersByMeansOfAcquisition(kebele, (byte) 2 /*Inheritance*/, stageExpression));
                row6.createCell(38).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHoldersByMeansOfAcquisition(kebele, (byte) 3 /*Gift*/, stageExpression));
                row6.createCell(39).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHoldersByMeansOfAcquisition(kebele, (byte) 5 /*Divorce*/, stageExpression));
                row6.createCell(40).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHoldersByMeansOfAcquisition(kebele, (byte) 4 /*Reallocation*/, stageExpression));
                row6.createCell(41).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHoldersByMeansOfAcquisition(kebele, (byte) 7 /*OTHERS*/, stageExpression));
                row6.createCell(42).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHoldersByEncumbrances(kebele, (byte) 1 /*Right of Way*/, stageExpression));
                row6.createCell(43).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderNonNaturalHoldersByEncumbrances(kebele, (byte) 2 /*Rental arrangement/ leases*/, stageExpression));
                row6.createCell(44).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row6.createCell(45).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row6.createCell(46).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row6.createCell(47).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                ...
                row6.createCell(53).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row6.createCell(54).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row6.createCell(56).setCellValue(MasterRepository.getInstance().getFirstDataEntryDateInKebeleForNonNaturalHolders(kebele, stageExpression));
                row6.createCell(57).setCellValue(MasterRepository.getInstance().getLastDataEntryDateInKebeleForNonNaturalHolders(kebele, stageExpression));
                ...
                row7.createCell(34).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row7.createCell(35).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row7.createCell(36).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOtherHoldingTypesByMeansOfAcquisition(kebele, (byte) 1 /*Redistribution*/, stageExpression));
                row7.createCell(37).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOtherHoldingTypesByMeansOfAcquisition(kebele, (byte) 2 /*Inheritance*/, stageExpression));
                row7.createCell(38).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOtherHoldingTypesByMeansOfAcquisition(kebele, (byte) 3 /*Gift*/, stageExpression));
                row7.createCell(39).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOtherHoldingTypesByMeansOfAcquisition(kebele, (byte) 5 /*Divorce*/, stageExpression));
                row7.createCell(40).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOtherHoldingTypesByMeansOfAcquisition(kebele, (byte) 4 /*Reallocation*/, stageExpression));
                row7.createCell(41).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOtherHoldingTypesByMeansOfAcquisition(kebele, (byte) 7 /*OTHERS*/, stageExpression));
                row7.createCell(42).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOtherHoldingTypesByEncumbrances(kebele, (byte) 1 /*Right of Way*/, stageExpression));
                row7.createCell(43).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderOtherHoldingTypesByEncumbrances(kebele, (byte) 2 /*Rental arrangement/ leases*/, stageExpression));
                row7.createCell(44).setCellValue(MasterRepository.getInstance().getCountOfOtherHoldingTypesWithPhysicalImpairment(kebele, stageExpression));
                row7.createCell(45).setCellValue(MasterRepository.getInstance().getCountOfOtherHoldingTypesWithoutPhysicalImpairment(kebele, stageExpression));
                row7.createCell(46).setCellValue(MasterRepository.getInstance().getCountOfParcelsWithPersonsOfInterestUnderOtherHoldingTypes(kebele, stageExpression));
                row7.createCell(47).setCellValue(MasterRepository.getInstance().getCountOfPersonsWithInterestUnderOtherHoldingTypes(kebele, stageExpression));
                row7.createCell(48).setCellValue(MasterRepository.getInstance().getAverageNumberOfPIPerParcelsUnderOtherHoldingTypes(kebele, stageExpression));
                row7.createCell(49).setCellValue(MasterRepository.getInstance().getCountOfMalePersonsWithInterestUnderOtherHoldingTypes(kebele, stageExpression));
                row7.createCell(50).setCellValue(MasterRepository.getInstance().getCountOfFemalePersonsWithInterestUnderOtherHoldingTypes(kebele, stageExpression));

                row7.createCell(51).setCellValue(MasterRepository.getInstance().getCountOfParcelsWithGuardiansUnderOtherHoldingTypes(kebele, stageExpression));
                row7.createCell(52).setCellValue(MasterRepository.getInstance().getCountOfGuardiansForParcelsUnderOtherHoldingTypes(kebele, stageExpression));
                row7.createCell(53).setCellValue(MasterRepository.getInstance().getAverageNumberOfGuardiansPerParcelsUnderOtherHoldingTypes(kebele, stageExpression));
                row7.createCell(54).setCellValue(MasterRepository.getInstance().getCountOfMaleGuardiansForParcelsUnderOtherHoldingTypes(kebele, stageExpression));
                row7.createCell(55).setCellValue(MasterRepository.getInstance().getCountOfFemaleGuardiansForParcelsUnderOtherHoldingTypes(kebele, stageExpression));
                row7.createCell(56).setCellValue(MasterRepository.getInstance().getFirstDataEntryDateInKebeleForOtherHoldingTypes(kebele, stageExpression));
                row7.createCell(57).setCellValue(MasterRepository.getInstance().getLastDataEntryDateInKebeleForOtherHoldingTypes(kebele, stageExpression));

                row8.createCell(27).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeByHoldingType(kebele, (byte) 1 /*Individual*/, stageExpression));
                row8.createCell(28).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeByHoldingType(kebele, (byte) 2 /*Communal*/,stageExpression));
                row8.createCell(29).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeByHoldingType(kebele, (byte) 3 /*Public/Instituional*/, stageExpression));
                row8.createCell(30).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeByHoldingType(kebele, (byte) 4 /*State*/, stageExpression));
                row8.createCell(31).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeByOrganisationType(kebele, (byte) 2 /*Church*/, stageExpression));
                row8.createCell(32).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeByOrganisationType(kebele, (byte) 3 /*Mosque*/, stageExpression));
                row8.createCell(33).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeByOrganisationType(kebele, (byte) 1 /*School*/, stageExpression));
                row8.createCell(34).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeByOrganisationType(kebele, (byte) 4 /*Health Center*/, stageExpression));
                row8.createCell(35).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeByOrganisationType(kebele, (byte) 5 /*Other*/, stageExpression));
                row8.createCell(36).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeByMeansOfAcquisition(kebele, (byte) 1 /*Redistribution*/, stageExpression));
                row8.createCell(37).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeByMeansOfAcquisition(kebele, (byte) 2 /*Inheritance*/, stageExpression));
                row8.createCell(38).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeByMeansOfAcquisition(kebele, (byte) 3 /*Gift*/, stageExpression));
                row8.createCell(39).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeByMeansOfAcquisition(kebele, (byte) 5 /*Divorce*/, stageExpression));
                row8.createCell(40).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeByMeansOfAcquisition(kebele, (byte) 4 /*Reallocation*/, stageExpression));
                row8.createCell(41).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeByMeansOfAcquisition(kebele, (byte) 7 /*OTHERS*/, stageExpression));
                row8.createCell(42).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeByEncumbrances(kebele, (byte) 1 /*Right of Way*/, stageExpression));
                row8.createCell(43).setCellValue(MasterRepository.getInstance().getCountOfParcelsUnderDisputeByEncumbrances(kebele, (byte) 2 /*Rental arrangement/ leases*/, stageExpression));
                row8.createCell(44).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row8.createCell(45).setCellValue(createHelper.createRichTextString("---")/*Data Not available*/);
                row8.createCell(46).setCellValue(MasterRepository.getInstance().getCountOfParcelsWithPersonsOfInterestUnderDispute(kebele, stageExpression));
                row8.createCell(47).setCellValue(MasterRepository.getInstance().getCountOfPersonsWithInterestForParcelsWithDispute(kebele, stageExpression));
                row8.createCell(48).setCellValue(MasterRepository.getInstance().getAverageNumberOfPIPerParcelsUnderDispute(kebele, stageExpression));
                row8.createCell(49).setCellValue(MasterRepository.getInstance().getCountOfMalePersonsWithInterestForParcelsWithDispute(kebele, stageExpression));
                row8.createCell(50).setCellValue(MasterRepository.getInstance().getCountOfFemalePersonsWithInterestForParcelsWithDispute(kebele, stageExpression));

                row8.createCell(51).setCellValue(MasterRepository.getInstance().getCountOfParcelsWithGuardiansUnderDispute(kebele, stageExpression));
                row8.createCell(52).setCellValue(MasterRepository.getInstance().getCountOfGuardiansForParcelsWithDispute(kebele, stageExpression));
                row8.createCell(53).setCellValue(MasterRepository.getInstance().getAverageNumberOfGuardiansPerParcelsUnderDispute(kebele, stageExpression));
                row8.createCell(54).setCellValue(MasterRepository.getInstance().getCountOfMaleGuardiansForParcelsWithDispute(kebele, stageExpression));
                row8.createCell(55).setCellValue(MasterRepository.getInstance().getCountOfFemaleGuardiansForParcelsWithDispute(kebele, stageExpression));
                row8.createCell(56).setCellValue(MasterRepository.getInstance().getFirstDataEntryDateInKebeleForParcelsWithDispute(kebele, stageExpression));
                row8.createCell(57).setCellValue(MasterRepository.getInstance().getLastDataEntryDateInKebeleForParcelsWithDispute(kebele, stageExpression));
                ...
                row10.createCell(27).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsByHoldingType(kebele, (byte) 1 /*Individual*/, stageExpression));
                row10.createCell(28).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsByHoldingType(kebele, (byte) 2 /*Communal*/, stageExpression));
                row10.createCell(29).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsByHoldingType(kebele, (byte) 3 /*Public/Instituional*/, stageExpression));
                row10.createCell(30).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsByHoldingType(kebele, (byte) 4 /*State*/, stageExpression));
                row10.createCell(31).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsByOrganisationType(kebele, (byte) 2 /*Church*/, stageExpression));
                row10.createCell(32).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsByOrganisationType(kebele, (byte) 3 /*Mosque*/, stageExpression));
                row10.createCell(33).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsByOrganisationType(kebele, (byte) 1 /*School*/, stageExpression));
                row10.createCell(34).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsByOrganisationType(kebele, (byte) 4 /*Health Center*/, stageExpression));
                row10.createCell(35).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsByOrganisationType(kebele, (byte) 5 /*Other*/, stageExpression));
                row10.createCell(36).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsByMeansOfAcquisition(kebele, (byte) 1 /*Redistribution*/, stageExpression));
                row10.createCell(37).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsByMeansOfAcquisition(kebele, (byte) 2 /*Inheritance*/, stageExpression));
                row10.createCell(38).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsByMeansOfAcquisition(kebele, (byte) 3 /*Gift*/, stageExpression));
                row10.createCell(39).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsByMeansOfAcquisition(kebele, (byte) 5 /*Divorce*/, stageExpression));
                row10.createCell(40).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsByMeansOfAcquisition(kebele, (byte) 4 /*Reallocation*/, stageExpression));
                row10.createCell(41).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsByMeansOfAcquisition(kebele, (byte) 7 /*OTHERS*/, stageExpression));
                row10.createCell(42).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsByEncumbrances(kebele, (byte) 1 /*Right of Way*/, stageExpression));
                row10.createCell(43).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsByEncumbrances(kebele, (byte) 2 /*Rental arrangement/ leases*/, stageExpression));
                row10.createCell(44).setCellValue(MasterRepository.getInstance().getCountOfAllHoldersWithPhysicalImpairment(kebele, stageExpression));
                row10.createCell(45).setCellValue(MasterRepository.getInstance().getCountOfAllHoldersWithoutPhysicalImpairment(kebele, stageExpression));
                row10.createCell(46).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsWithPersonsOfInterest(kebele, stageExpression));
                row10.createCell(47).setCellValue(MasterRepository.getInstance().getCountOfPersonsWithInterestForAllParcels(kebele, stageExpression));
                row10.createCell(48).setCellValue(MasterRepository.getInstance().getAverageNumberOfPIPerParcelForAllParcels(kebele, stageExpression));
                row10.createCell(49).setCellValue(MasterRepository.getInstance().getCountOfMalePersonsWithInterestForAllParcels(kebele, stageExpression));
                row10.createCell(50).setCellValue(MasterRepository.getInstance().getCountOfFemalePersonsWithInterestForAllParcels(kebele, stageExpression));

                row10.createCell(51).setCellValue(MasterRepository.getInstance().getCountOfAllParcelsWithGuardians(kebele, stageExpression));
                row10.createCell(52).setCellValue(MasterRepository.getInstance().getCountOfGuardiansForAllParcels(kebele, stageExpression));
                row10.createCell(53).setCellValue(MasterRepository.getInstance().getAverageNumberOfGuardiansPerParcelForAllParcels(kebele, stageExpression));
                row10.createCell(54).setCellValue(MasterRepository.getInstance().getCountOfMaleGuardiansForAllParcels(kebele, stageExpression));
                row10.createCell(55).setCellValue(MasterRepository.getInstance().getCountOfFemaleGuardiansForAllParcels(kebele, stageExpression));
                row10.createCell(56).setCellValue(MasterRepository.getInstance().getFirstDataEntryDateInKebeleForAllParcels(kebele));
                row10.createCell(57).setCellValue(MasterRepository.getInstance().getLastDataEntryDateInKebeleForAllParcels(kebele));
                ...
                row2 = disputeSheet.createRow((short) 2);
                row2.createCell(0).setCellValue(createHelper.createRichTextString("Inheritance"));
                row2.createCell(1).setCellValue(MasterRepository.getInstance().getNumberOfDisputesByType(kebele, (byte) 1 /*Inheritance*/, stageExpression));
                row2.createCell(2).setCellValue(MasterRepository.getInstance().getNumberOfPeopleInDisputeByType(kebele, (byte) 1 /*Inheritance*/, stageExpression));
                row2.createCell(3).setCellValue(MasterRepository.getInstance().getNumberOfHoldersInDisputeByType(kebele, (byte) 1 /*Inheritance*/, stageExpression));
                row2.createCell(4).setCellValue(MasterRepository.getInstance().getNumberOfDisputantsInDisputeByType(kebele, (byte) 1 /*Inheritance*/, stageExpression));
                row2.createCell(5).setCellValue(MasterRepository.getInstance().getNumberOfMarriedCoupleHoldersInDisputeByType(kebele, (byte) 1 /*Inheritance*/, stageExpression));
                row2.createCell(6).setCellValue(MasterRepository.getInstance().getNumberOfSingleFemaleHoldersInDisputeByType(kebele, (byte) 1 /*Inheritance*/, stageExpression));
                row2.createCell(7).setCellValue(MasterRepository.getInstance().getNumberOfSingleMaleHoldersInDisputeByType(kebele, (byte) 1 /*Inheritance*/, stageExpression));
                row2.createCell(8).setCellValue(MasterRepository.getInstance().getNumberOfOrphanHoldersInDisputeByType(kebele, (byte) 1 /*Inheritance*/, stageExpression));
                row2.createCell(9).setCellValue(MasterRepository.getInstance().getNumberOfNonNaturalHoldersInDisputeByType(kebele, (byte) 1 /*Inheritance*/, stageExpression));
                row2.createCell(10).setCellValue(MasterRepository.getInstance().getNumberOfOtherHoldingTypesInDisputeByType(kebele, (byte) 1 /*Inheritance*/, stageExpression));
                row2.createCell(11).setCellValue(MasterRepository.getInstance().getNumberOfDisputesByTypeAndStatus(kebele, (byte) 1 /*Inheritance*/, (byte) 1 /*Elders Committee*/, stageExpression));
                row2.createCell(12).setCellValue(MasterRepository.getInstance().getNumberOfDisputesByTypeAndStatus(kebele, (byte) 1 /*Inheritance*/, (byte) 2 /*Kebele Land Administration Committee*/, stageExpression));
                row2.createCell(13).setCellValue(MasterRepository.getInstance().getNumberOfDisputesByTypeAndStatus(kebele, (byte) 1 /*Inheritance*/, (byte) 3 /*Woreda Court*/, stageExpression));
                row2.createCell(14).setCellValue(MasterRepository.getInstance().getNumberOfDisputesByTypeAndStatus(kebele, (byte) 1 /*Inheritance*/, (byte) 4 /*Others*/, stageExpression));

                row3 = disputeSheet.createRow((short) 3);
                row3.createCell(0).setCellValue(createHelper.createRichTextString("Ownership right"));
                row3.createCell(1).setCellValue(MasterRepository.getInstance().getNumberOfDisputesByType(kebele, (byte) 2 /*"Ownership" of Land Use Right*/, stageExpression));
                row3.createCell(2).setCellValue(MasterRepository.getInstance().getNumberOfPeopleInDisputeByType(kebele, (byte) 2 /*"Ownership" of Land Use Right*/, stageExpression));
                row3.createCell(3).setCellValue(MasterRepository.getInstance().getNumberOfHoldersInDisputeByType(kebele, (byte) 2 /*"Ownership" of Land Use Right*/, stageExpression));
                row3.createCell(4).setCellValue(MasterRepository.getInstance().getNumberOfDisputantsInDisputeByType(kebele, (byte) 2 /*"Ownership" of Land Use Right*/, stageExpression));
                row3.createCell(5).setCellValue(MasterRepository.getInstance().getNumberOfMarriedCoupleHoldersInDisputeByType(kebele, (byte) 2 /*"Ownership" of Land Use Right*/, stageExpression));
                row3.createCell(6).setCellValue(MasterRepository.getInstance().getNumberOfSingleFemaleHoldersInDisputeByType(kebele, (byte) 2 /*"Ownership" of Land Use Right*/, stageExpression));
                row3.createCell(7).setCellValue(MasterRepository.getInstance().getNumberOfSingleMaleHoldersInDisputeByType(kebele, (byte) 2 /*"Ownership" of Land Use Right*/, stageExpression));
                row3.createCell(8).setCellValue(MasterRepository.getInstance().getNumberOfOrphanHoldersInDisputeByType(kebele, (byte) 2 /*"Ownership" of Land Use Right*/, stageExpression));
                row3.createCell(9).setCellValue(MasterRepository.getInstance().getNumberOfNonNaturalHoldersInDisputeByType(kebele, (byte) 2 /*"Ownership" of Land Use Right*/, stageExpression));
                row3.createCell(10).setCellValue(MasterRepository.getInstance().getNumberOfOtherHoldingTypesInDisputeByType(kebele, (byte) 2 /*"Ownership" of Land Use Right*/, stageExpression));
                row3.createCell(11).setCellValue(MasterRepository.getInstance().getNumberOfDisputesByTypeAndStatus(kebele, (byte) 2 /*"Ownership" of Land Use Right*/, (byte) 1 /*Elders Committee*/, stageExpression));
                row3.createCell(12).setCellValue(MasterRepository.getInstance().getNumberOfDisputesByTypeAndStatus(kebele, (byte) 2 /*"Ownership" of Land Use Right*/, (byte) 2 /*Kebele Land Administration Committee*/, stageExpression));
                row3.createCell(13).setCellValue(MasterRepository.getInstance().getNumberOfDisputesByTypeAndStatus(kebele, (byte) 2 /*"Ownership" of Land Use Right*/, (byte) 3 /*Woreda Court*/, stageExpression));
                row3.createCell(14).setCellValue(MasterRepository.getInstance().getNumberOfDisputesByTypeAndStatus(kebele, (byte) 2 /*"Ownership" of Land Use Right*/, (byte) 4 /*Others*/, stageExpression));
                row4 = disputeSheet.createRow((short) 4);
                row4.createCell(0).setCellValue(createHelper.createRichTextString("Boundary"));
                row4.createCell(1).setCellValue(MasterRepository.getInstance().getNumberOfDisputesByType(kebele, (byte) 3 /*"Boundary"*/, stageExpression));
                row4.createCell(2).setCellValue(MasterRepository.getInstance().getNumberOfPeopleInDisputeByType(kebele, (byte) 3 /*"Boundary"*/, stageExpression));
                row4.createCell(3).setCellValue(MasterRepository.getInstance().getNumberOfHoldersInDisputeByType(kebele, (byte) 3 /*"Boundary"*/, stageExpression));
                row4.createCell(4).setCellValue(MasterRepository.getInstance().getNumberOfDisputantsInDisputeByType(kebele, (byte) 3 /*"Boundary"*/, stageExpression));
                row4.createCell(5).setCellValue(MasterRepository.getInstance().getNumberOfMarriedCoupleHoldersInDisputeByType(kebele, (byte) 3 /*"Boundary"*/, stageExpression));
                row4.createCell(6).setCellValue(MasterRepository.getInstance().getNumberOfSingleFemaleHoldersInDisputeByType(kebele, (byte) 3 /*"Boundary"*/, stageExpression));
                row4.createCell(7).setCellValue(MasterRepository.getInstance().getNumberOfSingleMaleHoldersInDisputeByType(kebele, (byte) 3 /*"Boundary"*/, stageExpression));
                row4.createCell(8).setCellValue(MasterRepository.getInstance().getNumberOfOrphanHoldersInDisputeByType(kebele, (byte) 3 /*"Boundary"*/, stageExpression));
                row4.createCell(9).setCellValue(MasterRepository.getInstance().getNumberOfNonNaturalHoldersInDisputeByType(kebele, (byte) 3 /*"Boundary"*/, stageExpression));
                row4.createCell(10).setCellValue(MasterRepository.getInstance().getNumberOfOtherHoldingTypesInDisputeByType(kebele, (byte) 3 /*"Boundary"*/, stageExpression));
                row4.createCell(11).setCellValue(MasterRepository.getInstance().getNumberOfDisputesByTypeAndStatus(kebele, (byte) 3 /*"Boundary"*/, (byte) 1 /*Elders Committee*/, stageExpression));
                row4.createCell(12).setCellValue(MasterRepository.getInstance().getNumberOfDisputesByTypeAndStatus(kebele, (byte) 3 /*"Boundary"*/, (byte) 2 /*Kebele Land Administration Committee*/, stageExpression));
                row4.createCell(13).setCellValue(MasterRepository.getInstance().getNumberOfDisputesByTypeAndStatus(kebele, (byte) 3 /*"Boundary"*/, (byte) 3 /*Woreda Court*/, stageExpression));
                row4.createCell(14).setCellValue(MasterRepository.getInstance().getNumberOfDisputesByTypeAndStatus(kebele, (byte) 3 /*"Boundary"*/, (byte) 4 /*Others*/, stageExpression));
                row5 = disputeSheet.createRow((short) 5);
                row5.createCell(0).setCellValue(createHelper.createRichTextString("Other"));
                row5.createCell(1).setCellValue(MasterRepository.getInstance().getNumberOfDisputesByType(kebele, (byte) 4 /*Other*/, stageExpression));
                row5.createCell(2).setCellValue(MasterRepository.getInstance().getNumberOfPeopleInDisputeByType(kebele, (byte) 4 /*Other*/, stageExpression));
                row5.createCell(3).setCellValue(MasterRepository.getInstance().getNumberOfHoldersInDisputeByType(kebele, (byte) 4 /*Other*/, stageExpression));
                row5.createCell(4).setCellValue(MasterRepository.getInstance().getNumberOfDisputantsInDisputeByType(kebele, (byte) 4 /*Other*/, stageExpression));
                row5.createCell(5).setCellValue(MasterRepository.getInstance().getNumberOfMarriedCoupleHoldersInDisputeByType(kebele, (byte) 4 /*Other*/, stageExpression));
                row5.createCell(6).setCellValue(MasterRepository.getInstance().getNumberOfSingleFemaleHoldersInDisputeByType(kebele, (byte) 4 /*Other*/, stageExpression));
                row5.createCell(7).setCellValue(MasterRepository.getInstance().getNumberOfSingleMaleHoldersInDisputeByType(kebele, (byte) 4 /*Other*/, stageExpression));
                row5.createCell(8).setCellValue(MasterRepository.getInstance().getNumberOfOrphanHoldersInDisputeByType(kebele, (byte) 4 /*Other*/, stageExpression));
                row5.createCell(9).setCellValue(MasterRepository.getInstance().getNumberOfNonNaturalHoldersInDisputeByType(kebele, (byte) 4 /*Other*/, stageExpression));
                row5.createCell(10).setCellValue(MasterRepository.getInstance().getNumberOfOtherHoldingTypesInDisputeByType(kebele, (byte) 4 /*Other*/, stageExpression));
                row5.createCell(11).setCellValue(MasterRepository.getInstance().getNumberOfDisputesByTypeAndStatus(kebele, (byte) 4 /*Other*/, (byte) 1 /*Elders Committee*/, stageExpression));
                row5.createCell(12).setCellValue(MasterRepository.getInstance().getNumberOfDisputesByTypeAndStatus(kebele, (byte) 4 /*Other*/, (byte) 2 /*Kebele Land Administration Committee*/, stageExpression));
                row5.createCell(13).setCellValue(MasterRepository.getInstance().getNumberOfDisputesByTypeAndStatus(kebele, (byte) 4 /*Other*/, (byte) 3 /*Woreda Court*/, stageExpression));
                row5.createCell(14).setCellValue(MasterRepository.getInstance().getNumberOfDisputesByTypeAndStatus(kebele, (byte) 4 /*Other*/, (byte) 4 /*Others*/, stageExpression));
                row6 = disputeSheet.createRow((short) 6);
                row6.createCell(0).setCellValue(createHelper.createRichTextString("All"));
                row6.createCell(1).setCellValue(MasterRepository.getInstance().getNumberOfAllDisputes(kebele, stageExpression));
                row6.createCell(2).setCellValue(MasterRepository.getInstance().getNumberOfPeopleAllDisputes(kebele, stageExpression));
                row6.createCell(3).setCellValue(MasterRepository.getInstance().getNumberOfHoldersInAllDisputes(kebele, stageExpression));
                row6.createCell(4).setCellValue(MasterRepository.getInstance().getNumberOfDisputantsInAllDisputes(kebele, stageExpression));
                row6.createCell(5).setCellValue(MasterRepository.getInstance().getNumberOfMarriedCoupleHoldersInAllDisputes(kebele, stageExpression));
                row6.createCell(6).setCellValue(MasterRepository.getInstance().getNumberOfSingleFemaleHoldersInAllDisputes(kebele, stageExpression));
                row6.createCell(7).setCellValue(MasterRepository.getInstance().getNumberOfSingleMaleHoldersInAllDisputes(kebele, stageExpression));
                row6.createCell(8).setCellValue(MasterRepository.getInstance().getNumberOfOrphanHoldersInAllDisputes(kebele, stageExpression));
                row6.createCell(9).setCellValue(MasterRepository.getInstance().getNumberOfNonNaturalHoldersInAllDisputes(kebele, stageExpression));
                row6.createCell(10).setCellValue(MasterRepository.getInstance().getNumberOfOtherHoldingTypesInAllDisputes(kebele, stageExpression));
                row6.createCell(11).setCellValue(MasterRepository.getInstance().getNumberOfAllDisputesByStatus(kebele, (byte) 1 /*Elders Committee*/, stageExpression));
                row6.createCell(12).setCellValue(MasterRepository.getInstance().getNumberOfAllDisputesByStatus(kebele, (byte) 2 /*Kebele Land Administration Committee*/, stageExpression));
                row6.createCell(13).setCellValue(MasterRepository.getInstance().getNumberOfAllDisputesByStatus(kebele, (byte) 3 /*Woreda Court*/, stageExpression));
                row6.createCell(14).setCellValue(MasterRepository.getInstance().getNumberOfAllDisputesByStatus(kebele, (byte) 4 /*Others*/, stageExpression));
                disputeSheet.addMergedRegion(new CellRangeAddress(0, 0, 11, 14));
                //for (int x = 0; x < 14/*Number of columns*/; x++) {
                //    disputeSheet.autoSizeColumn(x, true);
                //}
